  ...
  return (
    <section className="relative ">
      <section className="flex gap-1">
        <select name="" id="" className={`bg-secondary custom-select pl-5 text-gray-200 text-h4-normal w-[130px] h-[50px] rounded-tl-[10px] rounded-bl-[10px] ${
      ...
      <svg className={`absolute pointer-events-none top-[9px] ml-[92px] w-8 h-8 ${
          page === "/likedSongs" ? "invert" : ""
        }`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 14l-4-4h8z" fill="#C4C4C4"/></svg>
      <img
