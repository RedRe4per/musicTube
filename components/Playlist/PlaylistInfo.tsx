    ...
    <section className="mt-6 pl-10 pb-5 flex">
      ...
      <section className="ml-10 mt-10 flex flex-col justify-around">
        <section className="flex gap-8 text-h3-normal text-gray-200">
          <span><span className="text-green">{playCount}</span>&nbsp;Played</span>
          <span><span className="text-green">{subscribedCount}</span>&nbsp;subscribed</span>
          <span><span className="text-green">{shareCount}</span>&nbsp;shared</span>
        </section>
        <h3 className="text-h2-normal text-white-200">{name}</h3>
        <section>
          {tags && <h5 className="text-tag-normal text-gray-200">
            Tags:{" "}
