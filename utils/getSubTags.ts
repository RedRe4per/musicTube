export const getSubTags = (englishTag: string) => {
    ...
    switch (englishTag) {
      case "Chinese":
        subTags = ["Mandopop", "C-pop", "Chinese Rock", "Chinese Folk", "Chinese Hip-Hop"];
        break;
      case "Western":
        subTags = ["Pop", "Rock", "Hip-Hop", "Country", "Electronic", "Jazz"];
        break;
      case "Korean":
        subTags = ["K-pop", "Korean Rock", "Korean Hip-Hop", "Korean R&B", "Korean Folk"];
        break;
      case "Japanese":
        subTags = ["J-pop", "J-rock", "Japanese Hip-Hop", "Japanese R&B", "Japanese Electronic"];
        break;
      case "Cantonese":
        subTags = ["Cantopop", "Cantonese Rock", "Cantonese Folk", "Cantonese Hip-Hop"];
        break;
      case "Alternative/Independent":
        subTags = ["Alternative Rock", "Indie Pop", "Indie Rock", "Indie Electronic", "Indie Folk"];
        break;
      case "R&B/Soul":
      ...
      case "Sexy":
        ...
        break;
      case "Rock":
        subTags = ["Classic Rock", "Alternative Rock", "Hard Rock", "Progressive Rock", "Indie Rock"];
        break;
      case "British":
        subTags = ["Britpop", "British Rock", "British Electronic", "British Folk", "British R&B"];
        break;
      case "Post_Rock":
        subTags = ["Instrumental", "Experimental", "Ambient", "Minimal", "Drone"];
        break;
      case "Ancient style":
        subTags = ["Traditional", "Chinese Classical", "Folk", "Guqin", "Guzheng"];
        break;
        case "Folk":
            subTags = ["Singer-Songwriter", "Americana", "Bluegrass", "Contemporary Folk", "Traditional Folk"];
            break;
          case "Blues":
            subTags = ["Delta Blues", "Chicago Blues", "Electric Blues", "Acoustic Blues", "Blues Rock"];
            break;
          case "Country":
            subTags = ["Contemporary Country", "Classic Country", "Alt-Country", "Bluegrass", "Country Rock"];
            break;
          case "Romantic":
          ...
          case "Happy":
            ...
            break;
          case "Classic":
            subTags = ["Classical", "Baroque", "Romantic", "Contemporary", "Minimalism"];
            break;
          case "World music":
          ...
          case "Jazz":
            ...
            break;
          case "Touching":
            subTags = ["Emotional", "Heartfelt", "Moving", "Poignant", "Soul-Stirring"];
            break;
          case "Lonely":
            subTags = ["Melancholic", "Solitude", "Reflective", "Introspective", "Sorrowful"];
            break;
          case "Relaxing":
            subTags = ["Chillout", "Ambient", "Meditation", "New Age", "Sleep"];
            break;
          case "Guitar":
            subTags = ["Acoustic", "Electric", "Classical", "Flamenco", "Fingerstyle"];
            break;
          case "Latin":
            subTags = ["Salsa", "Tango", "Bossa Nova", "Reggaeton", "Latin Pop"];
            break;
          case "Emotional":
            subTags = ["Tearjerkers", "Heartbreaking", "Passionate", "Dramatic", "Deep"];
            break;
          case "Healing":
            subTags = ["Therapeutic", "Calming", "Soothing", "Restorative", "Rejuvenating"];
            break;
          case "Piano":
            ...
            case "Peaceful":
                ...
                break;
              case "Afternoon Tea":
                subTags = ["Lounge", "Light Jazz", "Acoustic", "Easy Listening", "Chillout"];
                break;
              case "Online Songs":
                subTags = ["Viral Hits", "Internet Sensations", "Meme Songs", "Trending", "Online Collaborations"];
                break;
              case "Traveling":
              ...
              case "Strolling":
                ...
                break;
              case "Refreshing":
                subTags = ["Uplifting", "Energizing", "Revitalizing", "Invigorating", "Crisp"];
                break;
              case "80s Generation":
              ...
              case "Top Chart":
                ...
                break;
              case "Variety Show":
                subTags = ["TV Soundtracks", "Comedy", "Talk Shows", "Interviews", "Sketches"];
                break;
              case "Morning":
                subTags = ["Wake Up", "Early Bird", "Sunrise", "Breakfast", "Start Your Day"];
                break;
              case "Kids":
                subTags = ["Children's Music", "Lullabies", "Nursery Rhymes", "Sing-Alongs", "Storytelling"];
                break;
              case "Campus":
                subTags = ["College", "University", "High School", "School Life", "Student"];
                break;
              case "Workplace":
                subTags = ["Office", "Productivity", "Focus", "Background Music", "Ambient"];
                break;
              case "70s Generation":
                subTags = ["70s Pop", "70s Rock", "Disco", "Funk", "Soul"];
                break;
              case "90s Generation":
                subTags = ["90s Pop", "90s Rock", "90s R&B", "90s Hip-Hop", "Alternative"];
                break;
              case "Metro":
                subTags = ["Subway", "Commuting", "City Life", "Urban", "Public Transport"];
                break;
              case "Road Trip":
              ...
              case "Pub":
                ...
                break;
                case "Covers":
                    subTags = ["Acoustic Covers", "Live Covers", "Remixes", "Reinterpretations", "Tributes"];
                    break;
                  case "Ethnic":
                  ...
                  case "Missing":
                    ...
                    break;
                  case "Metal":
                    subTags = ["Heavy Metal", "Death Metal", "Black Metal", "Thrash Metal", "Power Metal"];
                    break;
                  case "Punk":
                  ...
                  case "Reggae":
                    ...
                    break;
                  case "Post Rock":
                    subTags = ["Instrumental", "Experimental", "Ambient", "Atmospheric", "Progressive"];
                    break;
                  case "Dance":
                    subTags = ["EDM", "House", "Techno", "Trance", "Electro"];
                    break;
                  case "Game":
                    subTags = ["Video Game Music", "Chiptune", "Soundtracks", "8-bit", "Orchestral"];
                    break;
                  case "Gen Z Music":
